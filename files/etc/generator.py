...
def replace_values(filename):
    ...
    for name, (pattern, chars) in patterns.items():
        ...
        if matches:
            for match in matches:
                ...
                print(f'Variable {name} was successfully replaced by {new_value.decode("utf-8", errors="ignore")}.')
                print("")
        else:
    ...
    if 'servicetag' in replacements:
        ...
        print("Unable to get the last 2 bytes of the servicetag. Using the default 'XXXX'.")
